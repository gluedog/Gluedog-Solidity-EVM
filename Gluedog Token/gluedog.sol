...
/* Gluedog Token source code (EVM Edition) */

contract GluedogToken 
{
    ...
    string public constant name = "Glue Dog";
    uint8 public constant decimals = 18;
    uint256 _totalSupply = 1111111000000000000000000;    // 1,111,111 tokens with 18 decimal places.
